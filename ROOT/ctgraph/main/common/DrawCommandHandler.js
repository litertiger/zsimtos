...
define(function (require, exports, module) {
    ...
    *     }
    ...
    var yard = require("../ct/obj/yard");
    var roadPoint = require("../ct/obj/roadPoint");
    ...
    DrawCommandHandler.prototype.alignLeft = function () {
        ...
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) minPosition = Math.min(current.position.x, minPosition);
        });
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) current.move(new go.Point(minPosition, current.position.y));
        });
    ...
    DrawCommandHandler.prototype.alignRight = function () {
        ...
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) {
                var rightSideLoc = current.actualBounds.x + current.actualBounds.width;
                maxPosition = Math.max(rightSideLoc, maxPosition);
            }
        });
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) current.move(new go.Point(maxPosition - current.actualBounds.width, current.position.y));
        });
    ...
    DrawCommandHandler.prototype.alignTop = function () {
        ...
        var minPosition = Infinity;
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) minPosition = Math.min(current.position.y, minPosition);
        });
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) current.move(new go.Point(current.position.x, minPosition));
        });
    ...
    DrawCommandHandler.prototype.alignBottom = function () {
        ...
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) current.move(new go.Point(current.actualBounds.x, maxPosition - current.actualBounds.height));
        });
    ...
    DrawCommandHandler.prototype.alignCenterX = function () {
        ...
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) current.move(new go.Point(centerX - current.actualBounds.width / 2, current.actualBounds.y));
        });
    ...
    DrawCommandHandler.prototype.alignCenterY = function () {
        ...
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) current.move(new go.Point(current.actualBounds.x, centerY - current.actualBounds.height / 2));
        });
    ...
    DrawCommandHandler.prototype.alignColumn = function (distance) {
        ...
        diagram.selection.each(function (current) {
            if (current.data instanceof yard || current.data instanceof roadPoint) selectedParts.push(current);
        });
    ...
    DrawCommandHandler.prototype.rotate = function (angle) {
        ...
        diagram.selection.each(function (current) {
            ...
            if (current.data instanceof yard) current.data.rotate = angle;
        });
    ...
    module.exports = DrawCommandHandler;
});