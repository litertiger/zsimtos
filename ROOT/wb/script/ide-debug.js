var Ide = {
    ...
    init: function() {
        ...
        for (a = 61440; a <= 61964; a++) {
            b = a.toString(16);
            if (b == "f02f" || b.slice( - 1) != "f" && Wb.indexOf(c, a) == -1) {
                Ide.glyphData.push(b);
            }
        }
        Ide.defineClasses();
        Wb.onUnload(function() {
            var d = Wb.getModifiedTitle(Ide.fileTab, true);
            if (d !== null) {
                return d + "已经被修改。";
            }
        });
    ...
    setPaper: function() {
        ...
        Wb.prompt({
            ...
            items: [{
                ...
                editable: false,
                value: 0,
                store: [[[210, 297], "A4纵向"], [[297, 210], "A4横向"], [[297, 420], "A3纵向"], [[420, 297], "A3横向"], [0, "自定义大小"]],
                listeners: {
                    change: function(c, e) {
    ...
    doApplyLayout: function(b, a) {
        ...
        function d(g, f) {
            var e, h = g.node,
                i = h.data.configs;
            if (!f) {
                i.x = g.getLocalX().toString();
                i.y = g.getLocalY().toString();
            }
            i.width = g.getWidth().toString();
            i.height = g.getHeight().toString();
            i.itemId = g._itemId;
            if ((g instanceof Ext.form.field.Base || g instanceof Ext.form.Label) && !(g instanceof Ext.form.field.Hidden)) {
                if (g.labelAlign == "left") {
                    i.labelAlign = "";
                } else {
                    i.labelAlign = g.labelAlign;
                }
            }
            if (g.handleText) {
                e = Wb.namePart(g.handleText);
                if (g[e]) {
                    i[e] = g[e];
                } else {
                    delete i[e];
    ...
    render: function(c, b, h) {
        var g = {},
            d, i, j = Ide.getMetaControl(b).data,
            a = j.general,
            e = parseInt(a.width, 10) || 120,
            k = parseInt(a.height, 10) || 22,
            f = b.data.configs;
        ...
        Wb.each(["width", "height"],
            function(l) {
                if (f[l]) {
                    g[l] = parseInt(f[l], 10);
                }
            });
        if (g.width === undefined && e) {
            g.width = h ? 480 : e;
        }
        if (g.height === undefined && k) {
            g.height = h ? 320 : k;
        }
    ...
    isResizer: function(a) {
        return a.clientWidth == 5 && a.clientHeight == 5;
    },
    ...
    fitComp: function(b) {
        var a = b.bindMask;
        if (Wb.setBox(b, a)) {
            a.el.setStyle("line-height", b.height + "px");
        }
    },
    dragComp: function(e) {
        var b, a = e.comp,
    ...
    addEvents: function() {
        ...
        a.on("click",
            function(f, d) {
                if (Ide.fileTree.el.isAncestor(d)) {
                    Ide.activeCmp = "file";
                    if (Wb.getSelText()) {
                        Wb.clearSelText();
                    }
                } else {
                    if (Ide.fileTab.el.isAncestor(d)) {
                        if (Wb.getSelText() && Wb.hasNS("activeCard.tree.el.isAncestor", Ide) && Ide.activeCard.tree.el.isAncestor(d)) {
                            Wb.clearSelText();
                        }
                        var c, b = Ide.activeCard;
                        if (b && b.designCard) {
                            c = b.getActiveTab();
                            if (c == b.designCard || c.layoutCard) {
    ...
    getXwlData: function(c) {
        var f, e, a = c.tree,
            b = a.getRootNode(),
            d = Ext.copyTo({},
                b.data, ["title", "hidden", "inframe", "pageLink", "iconCls"]);
        if (c.commitChange) {
            c.commitChange();
        }
    ...
    defineClasses: function() {
        ...
        Ext.define("Wb.ide.ColorField", {
            ...
            onExpand: function() {
                var b = this,
                    a = b.getValue();
                if (Ext.String.startsWith(a, "#")) {
                    a = a.substring(1);
                    if (Wb.indexOf(b.picker.colors, a) != -1) {
                        b.picker.select(a, true);
                    }
                }
            },
            onCollapse: function() {
        ...
        var a = Wb.prompt({
            ...
            items: [{
            ...
            },
                {
                    ...
                    fieldLabel: "修改日期",
                    itemId: "dateRange",
                    saveKeyname: "sys.ide.module.export",
                    items: [{
                        boxLabel: "全部",
                        checked: true
                    },
                    ...
                    listeners: {
                        change: function(d, e) {
                            var b = d.getComponent("modifyDate"),
                                c;
                            b.setDisabled(e != 3);
                            c = b.getValue();
                            var f = "";
            ...
            handler: function(b, d) {
                ...
                switch (b.dateRange) {
                    case 0:
                        ...
                        break;
                    case 1:
                        c = Ext.Date.clearTime(new Date());
                        break;
                    case 2:
                        c = Ext.Date.add(Ext.Date.clearTime(new Date()), Ext.Date.DAY, -1);
                        break;
                    case 3:
                        c = b.modifyDate;
                        break;
        ...
        Wb.run({
            ...
            success: function(a) {
                ...
                a.form1.add([{
                    ...
                    boxLabel: "导入 URL 捷径",
                    itemId: "mergeUrl",
                    checked: Ide.importUrlChecked !== false,
                    x: 50,
                    y: 56,
                    listeners: {
                        change: function(b, c) {
    ...
    doClose: function(a) {
        ...
        Ide.fileTab.items.each(function(b) {
            if (a && b == Ide.activeCard) {
                return;
            }
            if (b.isModified) {
                Ide.fileTab.setActiveTab(b);
                Wb.choose('"' + b.file + '" 已经被修改，保存所做的更改吗？',
                    function(c) {
                        if (c == "yes") {
                            Ide.saveFile(false, Ide.closeAll);
                        } else {
                            if (c == "no") {
                                Wb.unModified(b);
                                Ide.doClose();
    ...
    refreshThread: function() {
        ...
        Wb.request({
            ...
            success: function(b) {
                Ide.threadCard.update("<p>刷新时间：" + Wb.format(a, "Y-m-d H:i:s") + "</p>" + b.responseText);
            }
        });
    },
                    ...
                    },
                    {
                        ...
                        listeners: {
                            afterrender: {
                                ...
                                fn: function(k) {
                                    if (k.value) {
                                        k.setFieldCls(k.value);
                                    }
                                }
                            },
                            change: function(k, l) {
                                if (k.priorCls) {
                                    k.inputEl.removeCls(k.priorCls);
                                }
                                k.inputEl.addCls(l);
                                k.priorCls = l;
                            }
            ...
            handler: function(k) {
                ...
                Wb.request({
                    ...
                    success: function(p) {
                        ...
                        k = Ext.copyTo({},
                            k, ["text", "title", "hidden", "inframe", "pageLink", "icon", "iconCls", "cls"]);
                        Wb.update(f, k);
    ...
    addModule: function(c) {
            ...
            },
            {
                ...
                listeners: {
                    afterrender: {
                        ...
                        fn: function(d) {
                            if (d.value) {
                                d.setFieldCls(d.value);
                            }
                        }
                    },
                    change: function(d, e) {
                        if (d.priorCls) {
                            d.inputEl.removeCls(d.priorCls);
                        }
                        d.inputEl.addCls(e);
                        d.priorCls = e;
                    }
        ...
        Wb.prompt({
            title: "添加",
            width: 580,
            iconCls: c ? "folder_icon": "new_icon",
            items: a,
    ...
    addFile: function(a) {
        Wb.prompt({
            title: "添加",
            iconCls: a ? "folder_icon": "new_icon",
            items: [{
                fieldLabel: "名称",
                itemId: "name",
                allowBlank: false,
    ...
    getOutputs: function() {
        if (Ide.consoleQuerying) {
            return;
        }
        Ide.consoleQuerying = true;
        Ext.Ajax.request({
            url: "get-server-outputs",
            timeout: 5000,
            callback: function(c, b, g) {
                delete Ide.consoleQuerying;
                if (b) {
                    ...
                    if (d) {
                        ...
                        if (Ide.toggleOutputsBtn.pressed && Ext.Date.getElapsed(Ide.queryConsoleLast) > 1200000) {
                            Ide.toggleOutputsBtn.toggle(false);
                            Ide.queryConsoleLast = new Date();
                        }
                        return;
                    }
                    ...
                    if (!Ide.queryConsoleErrors) {
                        Ide.queryConsoleErrors = 0;
                    }
                    Ide.queryConsoleErrors++;
                    if (Ide.toggleOutputsBtn.pressed && Ide.queryConsoleErrors > 9) {
                        Ide.toggleOutputsBtn.toggle(false);
                        Ide.queryConsoleErrors = 0;
                    }
                }
    ...
    toggleGetOutputs: function(b, c) {
        if (c) {
            Ide.queryConsoleLast = new Date();
            if (Ide.queryConsoleTimer) {
                return;
            }
            Ide.queryConsoleTimer = setInterval(Ide.getOutputs, 1000);
        } else {
            if (Ide.queryConsoleTimer) {
                clearInterval(Ide.queryConsoleTimer);
    ...
    removeFiles: function() {
        ...
        Wb.confirm(a.length === 1 ? '确定要删除 "' + a[0].data.text + '" 吗？': "确定要删除选择的 " + a.length + " 项吗？",
            function() {
                Wb.request({
            ...
            listeners: {
                ...
                resize: function(k, j, i) {
                    if (k.editor && !k.destroying) {
                        Ext.fly(k.editor.getScrollerElement()).setHeight(i - k.toolbar.getHeight());
                        k.editor.refresh();
                    }
                },
                close: function(i) {
        ...
        if (f) {
            ...
            Ext.apply(c.listeners, {
                beforeclose: function(i) {
                    if (i.isModified) {
                        Wb.choose('"' + i.file + '" 已经被修改，保存所做的更改吗？',
                            function(j) {
                                if (j == "yes") {
                                    Ide.saveFile(false,
                                        function() {
    ...
    editGlyph: function() {
        return {
            ...
            store: Ide.glyphData,
            anyMatch: true,
            tpl: ['<div><tpl for=".">', '<div class="x-boundlist-item wb_thumb wb_glyph3" data-qtip="{field1}">', "{[String.fromCharCode(parseInt(values.field1,16))]}", "</div></tpl></div>"],
            listeners: {
                change: Ide.notifyChange
            }
        };
    ...
    loadProperties: function(b, d) {
        var c = [],
            f = {},
            e = Ide.getMetaControl(b);
        if (!e) {
            Wb.warn('控件 "' + b.data.type + '" 没有找到。');
            return;
        }
        function a(i, g, j) {
            var k, h;
            Wb.each(g,
                function(l, m) {
                    ...
                    switch (m.type) {
                        ...
                        case "enum":
                            f[l] = {
                                editor: Ide.editEnum(m.list || m.params)
                            };
                            break;
                        case "jndi":
                            f[l] = {
                        ...
                        default:
                            f[l] = {
                                editor: Ide.editString(l == "itemId")
                            };
                            break;
                    }
                    h = i[l] || "";
        ...
        a(b.data.configs || {},
            e.data.configs, "Configs");
        a(b.data.events || {},
            e.data.events, "Events");
        d.node = b;
        d.store.node = b;
        d.suspendEvents();
        ...
        b = Ide.fileTab.add({
            ...
            listeners: {
                afterrender: {
                    single: true,
                    fn: function(d) {
                        var e = d.getComponent("designCard");
                        d.designCard = e;
                ...
                activate: function(e) {
                    var d = e.getActiveTab();
                    if (!d) {
                        return;
                    }
                    if (d.lastScrollInfo) {
                        d.editor.scrollTo(d.lastScrollInfo.left, d.lastScrollInfo.top);
                    }
                    setTimeout(function() {
                            try {
                                if (d.editor.needRefresh) {
                                    d.editor.refresh();
                ...
                beforetabchange: function(f, d, e) {
                    var g = d.itemId == "designCard";
                    if (d.layoutCard || g) {
                ...
                tabchange: function(f, d, e) {
                    Ide.recordActivity();
                },
                beforeclose: function(d) {
                    if (d.isModified) {
                        Wb.choose('"' + d.file + '" 已经被修改，保存所做的更改吗？',
                            function(e) {
                                if (e == "yes") {
                                    Ide.saveFile(false,
                                        function() {
            ...
            items: [{
                ...
                items: [{
                    ...
                    store: new Ext.data.Store({
                        ...
                        groupField: "type",
                        listeners: {
                            update: function(i, d, e) {
                                if (e == "commit" && !i.stopUpdate) {
                                    var f = d.get("name"),
                                        j = d.get("value") || "",
                                        h = i.node,
                                        g = d.get("type").toLowerCase();
                                    if (!h.data[g]) {
                                        h.data[g] = {};
                                    }
                                    h.data[g][f] = j;
                                    if (f == "itemId") {
                                        Ide.syncBindRef(h.data.text, j);
                                        h.set("text", j);
                                        h.commit();
                                        Ide.syncNodes(h);
                                    } else {
                    ...
                    listeners: {
                        ...
                        afterrender: {
                            ...
                            fn: function(d) {
                                ...
                                d.columns[0].renderer = function(g, h, e) {
                                    var f = e.data.meta;
                                    h.tdCls = "wb-solid";
                                    if (f.deprecated) {
                                ...
                                d.columns[1].renderer = function(g, h, e) {
                                    if (g) {
                                        if (!Ext.String.startsWith(g, "@")) {
                                            var f = e.data.meta.type;
                                            switch (f) {
                                                case "iconCls":
                                                    g = Wb.getIcon(g) + g;
                                                    break;
                                                case "color":
                                                    ...
                                                    break;
                                                case "glyph":
                                                    g = '<span class="wb_glyph"> ' + String.fromCharCode(parseInt(g, 16)) + "</span> " + g;
                                                    break;
                                                default:
                ...
                },
                    {
                        ...
                        columns: [{
                            ...
                            renderer: function(f, g, d) {
                                var e = typeof(d.data.configs.text) == "undefined"?d.data.configs.title:d.data.configs.text ;
                                f = Wb.encodeHtml(f);
                                if (e) {
                                    return f + " (" + Wb.encodeHtml(e) + ")";
                                } else {
                                    return f;
                                }
                            }
                        ...
                        listeners: {
                            selectionchange: function(d, e) {
                                var f = e[0];
                                if (!f) {
                                    f = this.getRootNode().firstChild;
                                }
                        ...
                        viewConfig: {
                            ...
                            listeners: {
                                beforedrop: function(e, g, d, h, f) {
                                    if (g.view === Ide.controlTree.view) {
                                        g.copy = true;
                                    }
                                    Ide.autoRename(h == "append" ? d: d.parentNode, g.records, f);
                                },
                                drop: function(g, h, e, i) {
                                    var f, d = e.getOwnerTree();
                                    if (h.view == Ide.controlTree.view) {
                                        f = h.records[0];
                                        Ide.setNewNode(f, f.parentNode);
                                        d.setSelection(f);
                                        Ide.activeCmp = "control";
                                    } else {
                                        Ide.autoRename(i == "append" ? e: e.parentNode, h.records);
                                        d.setSelection(h.records);
                                        Ide.syncNodes(h.records);
                                    }
                                    Ide.setModified();
                                },
                                nodedragover: function(e, g, f) {
                                    var d = f.records[0];
                                    if (d.getOwnerTree() == Ide.controlTree && !d.data.control || e.getDepth() == 1 && g != "append") {
                                        return false;
                                    }
                                }
                            }
    ...
    run: function() {
        ...
        if (a.bindFile) {
            ...
            if (Ide.runGetOutputsBtn.checked && !Ide.toggleOutputsBtn.pressed) {
                setTimeout(Ide.getOutputs, 1000);
            }
        } else {
            Ide.saveFile(false,
                function() {
    ...
    setFieldAlign: function(e) {
        ...
        if (d && (d.layoutCard || d.itemId == "designCard")) {
            if (d.layoutCard) {
                ...
                Wb.each(Ide.activeCard.tree.getSelection(),
                    function(i) {
                        g = Ide.getMetaControl(i);
    ...
    exportFile: function(b) {
        var c = [],
            a = Ide.fileTree.getSelection();
        if (!a.length) {
        ...
        new Ext.container.Viewport({
            ...
            items: [{
                ...
                items: [{
                    ...
                    },
                    {
                        ...
                        menu: {
                            ...
                            items: [{
                                ...
                                "-", {
                                    text: "运行后获取服务端信息",
                                    itemId: "runGetOutputsBtn",
                                    checked: true,
                                    enableToggle: true
                                },
                                {
                                    text: "立即获取服务端信息",
                                    handler: Ide.getOutputs
                                }]
                        }
                    },
                    {
                        ...
                        menu: {
                            minWidth: 150,
                            items: [{
                                text: 'SQL生成器<span class="wb_right">Ctrl+Shift+B</span>',
                                iconCls: "sql_icon",
                                handler: Ide.setSQL
                            },
                                "-", {
                        ...
                        menu: {
                            ...
                            items: [{
                                ...
                                },
                                {
                                    ...
                                    handler: function() {
                                        Wb.choose("确定要压缩应用目录下以“-debug”结尾的所有调试文件吗？<br>警告：压缩生成的新文件名为去除“-debug”的文件名，如果文件存在将被覆盖。<br>[是]：压缩所有文件，[否]：压缩修改过的文件，[取消]：取消操作。",
                                            function(a) {
                                                if (a != "cancel") {
                                                    Wb.request({
                    ...
                    {
                        tooltip: "自动获取服务端信息 (Ctrl+I)",
                        overflowText: "自动获取服务端信息",
                        itemId: "toggleOutputsBtn",
                        iconCls: "console_icon",
                        enableToggle: true,
                        listeners: {
                            toggle: Ide.toggleGetOutputs
                        }
                    },
                    "->", {
                        text: "主卡",
                ...
                },
                {
                    ...
                    listeners: {
                        afterrender: {
                            single: true,
                            fn: function(a) {
                                a.mon(a.tabBar.el, "dblclick",
                                    function() {
                                        var b = Ide.activeCard;
                                        if (b && b.bindFile && !b.hasParams) {
                                        ...
                                        function(g) {
                                            if (d == "xwl") {
                                                ...
                                                if (g.path == a.data.path && c == a.data.nodePath && (e.itemType + "=" + e.itemName) == a.data.itemName) {
                                                    ...
                                                    if (a.data.nodePath) {
                                                        g.tree.selectPath("/Root" + a.data.nodePath, "text", "/",
                                                            function() {
